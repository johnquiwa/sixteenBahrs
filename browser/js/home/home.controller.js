...
// $scope.createJRemixer = function createJRemixer(context, jquery, apiKey) {
//     var $ = jquery;
...
//         remixTrack : function(track, trackURL, callback) {
            ...
            //                     track.buffer = context.createBuffer(res.data, false);
            //                     track.status = 'ok'
            //                     console.log(track);
            //                 } else {
...
//                 var threshold = 1;
//                 var distance = $scope.timbral_distance(seg1, seg2);
...
// $scope.euclidean_distance = function euclidean_distance(v1, v2) {
//     var sum = 0;
//     for (var i = 0; i < 3; i++) {
//         var delta = v2[i] - v1[i];
//         sum += delta * delta;
...
// $scope.timbral_distance = function timbral_distance(s1, s2) {
//     return $scope.euclidean_distance(s1.timbre, s2.timbre);
// }

// $scope.clusterSegments = function clusterSegments(track, numClusters, fieldName, vecName) {
...
// $scope.fixFileName = function fixFileName(name) {
...
// $scope.fetchSignature = function fetchSignature() {
